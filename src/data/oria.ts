...
export const UI = {
  pt: {
    ...
    atuacao: {
      ...
      intro: "Não há cardápio fixo. Cada mandato é estruturado conforme a situação exige.",
      pageNum: "§ ATUAÇÃO",
      frenteLabel: "FRENTE",
      metodoNum: "§ MÉTODO",
    ...
    socios: {
      ...
      intro: "Liderada por profissionais com experiência direta em reestruturação e decisões sob pressão.",
  ...
  en: {
    ...
    atuacao: {
      ...
      intro: "No fixed menu. Each engagement is structured around what the situation requires.",
      pageNum: "§ SERVICES",
    ...
    socios: {
      ...
      intro: "Led by professionals with direct experience in restructuring and high-pressure decisions.",
